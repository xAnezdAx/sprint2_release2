...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/EstilosAlbumesAdmin.css') }}">
    ...
    <div class=" my-5 animated-background">
        ...
        <div class="container mt-5">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <form action="{{ route('albumesAdmin.update', $album->id) }}" method="POST" onsubmit="return validateForm();" class="p-4 bg-light rounded shadow">
                        @csrf
                        @method('PUT')
