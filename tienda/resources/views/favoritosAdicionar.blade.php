...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/EstilosFavoritos.css') }}">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Descripción: {{$albume->descripcion}}</p>
                            ...
                            <form action="{{ route('favoritos.store') }}" method="POST">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <select name="lista_desplegable" id="lista_desplegable">
                                        ...
                                        <option value="{{ $favorito->id }}">{{ $favorito->nombre_lista }}</option>
                                        @endforeach
                                    </select>
